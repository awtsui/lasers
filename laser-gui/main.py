...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.frame_disconnect.grid_rowconfigure(2, weight=1)
        ...
        self.frame_disconnect_top.grid_columnconfigure(3, weight=1)
        self.frame_disconnect_top.grid(row=0, column=0)

        self.label_1 = customtkinter.CTkLabel(
            master=self.frame_disconnect, text="LASERS"
        )
        ...
        self.button_connect.grid(row=0, column=2, pady=10, padx=10)

        self.menu_lookup = customtkinter.CTkOptionMenu(
            master=self.frame_disconnect_top,
            values=["IP Address Lookup", "192.168.0.253"],
            command=self.menu_lookup_callback,
        )
        self.menu_lookup.grid(row=0, column=0, pady=10, padx=10)
        ...
        self.frame_connect_bot.grid_columnconfigure(2, weight=1)
        self.frame_connect_bot.grid_rowconfigure(3, weight=1)
        ...
        self.label_sensitivity = customtkinter.CTkLabel(
            master=self.frame_connect_bot, text="Sensitivity"
        )
        ...
        self.label_brightness = customtkinter.CTkLabel(
            master=self.frame_connect_bot, text="Brightness"
        )
